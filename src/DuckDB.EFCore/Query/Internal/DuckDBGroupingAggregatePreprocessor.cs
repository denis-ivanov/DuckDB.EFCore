...
public class DuckDBGroupingAggregatePreprocessor : ExpressionVisitor
{
        ...
        if (methodCallExpression.Method.DeclaringType == typeof(DuckDBGroupingExtensions))
        {
            switch (methodCallExpression.Method.Name)
            {
                case nameof(DuckDBGroupingExtensions.AnyValue)
                    ...
                    or nameof(DuckDBGroupingExtensions.VarPop)
                    or nameof(DuckDBGroupingExtensions.VarSamp)
                ...
                or nameof(DuckDBGroupingExtensions.CovarSamp)
                or nameof(DuckDBGroupingExtensions.RegrAvgx)
                ...
                or nameof(DuckDBGroupingExtensions.RegrSlope)
                or nameof(DuckDBGroupingExtensions.RegrSxx)
                or nameof(DuckDBGroupingExtensions.RegrSxy)
                or nameof(DuckDBGroupingExtensions.RegrSyy)
                    ...
                    return RewritePairAggregate(
                        ...
                        {
                            nameof(DuckDBGroupingExtensions.Corr) => DuckDBGroupingExtensions.CorrAggregateMethod,
                            nameof(DuckDBGroupingExtensions.CovarPop) => DuckDBGroupingExtensions.CovarPopAggregateMethod,
                            nameof(DuckDBGroupingExtensions.CovarSamp) => DuckDBGroupingExtensions.CovarSampAggregateMethod,
                            ...
                            nameof(DuckDBGroupingExtensions.RegrR2) => DuckDBGroupingExtensions.RegrR2AggregateMethod,
                            nameof(DuckDBGroupingExtensions.RegrSlope) => DuckDBGroupingExtensions.RegrSlopeAggregateMethod,
                            nameof(DuckDBGroupingExtensions.RegrSxx) => DuckDBGroupingExtensions.RegrSxxAggregateMethod,
                            nameof(DuckDBGroupingExtensions.RegrSxy) => DuckDBGroupingExtensions.RegrSxyAggregateMethod,
                            _ => DuckDBGroupingExtensions.RegrSyyAggregateMethod
                        });
                ...
                or nameof(DuckDBGroupingExtensions.QuantileDisc)
                    when methodCallExpression.Arguments.Count == 3
                    ...
                    return RewriteQuantile(
                        ...
                        methodCallExpression.Method.Name switch
                        {
                            ...
                            nameof(DuckDBGroupingExtensions.QuantileCont) => (DuckDBGroupingExtensions.QuantileContAggregateMethod, DuckDBGroupingExtensions.QuantileContArrayAggregateMethod),
                            _ => (DuckDBGroupingExtensions.QuantileDiscAggregateMethod, DuckDBGroupingExtensions.QuantileDiscArrayAggregateMethod)
                        });
    ...
    private static MethodInfo GetSingleSelectorAggregateMethod(string methodName)
        => methodName switch
        {
            ...
            nameof(DuckDBGroupingExtensions.VarPop) => DuckDBGroupingExtensions.VarPopAggregateMethod,
            nameof(DuckDBGroupingExtensions.VarSamp) => DuckDBGroupingExtensions.VarSampAggregateMethod,
