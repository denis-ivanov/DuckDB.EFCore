...
public class PrimitiveCollectionsQueryDuckDBTest : PrimitiveCollectionsQueryRelationalTestBase<PrimitiveCollectionsQueryDuckDBTest.PrimitiveCollectionsQueryDuckDBFixture>
{
    ...
    {
        return base.Inline_collection_List_Contains_with_mixed_value_types();
    }
    ...
    {
        return base.Inline_collection_List_Max_with_two_values();
    }

    [ConditionalFact(Skip = DuckDBSkipReasons.Tbd)]
    public override Task Inline_collection_List_Min_with_three_values()
    {
        return base.Inline_collection_List_Min_with_three_values();
    }

    [ConditionalFact(Skip = DuckDBSkipReasons.Tbd)]
    public override Task Inline_collection_List_Min_with_two_values()
    {
        return base.Inline_collection_List_Min_with_two_values();
    }

    [ConditionalFact(Skip = DuckDBSkipReasons.Tbd)]
    public override Task Inline_collection_Max_with_three_values()
    {
        return base.Inline_collection_Max_with_three_values();
    }

    [ConditionalFact(Skip = DuckDBSkipReasons.Tbd)]
    public override Task Inline_collection_Max_with_two_values()
    {
        return base.Inline_collection_Max_with_two_values();
    }

    [ConditionalFact(Skip = DuckDBSkipReasons.Tbd)]
    public override Task Inline_collection_Min_with_three_values()
    {
        return base.Inline_collection_Min_with_three_values();
    }
    ...
    {
        return base.Inline_collection_negated_Contains_as_All();
    }

    [ConditionalFact(Skip = DuckDBSkipReasons.Tbd)]
    public override Task Inline_collection_of_ints_Contains()
    {
        return base.Inline_collection_of_ints_Contains();
    }

    [ConditionalFact(Skip = DuckDBSkipReasons.Tbd)]
    public override Task Inline_collection_of_nullable_ints_Contains()
    {
        return base.Inline_collection_of_nullable_ints_Contains();
    }

    [ConditionalFact(Skip = DuckDBSkipReasons.Tbd)]
    public override Task Inline_collection_of_nullable_ints_Contains_null()
    {
        return base.Inline_collection_of_nullable_ints_Contains_null();
    }
    ...
    {
        return base.Inline_collection_with_single_parameter_element_Contains();
    }
    ...
    {
        return base.Nested_contains_with_arrays_and_no_inferred_type_mapping();
    }

    [ConditionalFact(Skip = DuckDBSkipReasons.Tbd)]
    public override Task Nested_contains_with_Lists_and_no_inferred_type_mapping()
    {
        return base.Nested_contains_with_Lists_and_no_inferred_type_mapping();
    }

    [ConditionalFact(Skip = DuckDBSkipReasons.Tbd)]
    public override Task Parameter_collection_Contains_with_EF_Constant()
    {
        return base.Parameter_collection_Contains_with_EF_Constant();
    }
    ...
    {
        return base.Parameter_collection_HashSet_of_ints_Contains_int();
    }
    ...
    {
        return base.Parameter_collection_of_nullable_structs_Contains_struct();
    }

    [ConditionalFact(Skip = DuckDBSkipReasons.Tbd)]
    public override Task Parameter_collection_of_strings_Contains_nullable_string()
    {
        return base.Parameter_collection_of_strings_Contains_nullable_string();
    }
    ...
    {
        return base.Parameter_collection_of_structs_Contains_nullable_struct();
    }
    ...
    {
        return base.Parameter_collection_of_structs_Contains_struct();
    }
